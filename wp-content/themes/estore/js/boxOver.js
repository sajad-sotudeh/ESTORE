  ...
  purchases = purchases.concat("+").concat(purchase);
	...
	switch( choice.id ){
		case "p1":
			...
			break;
		case "p2":
		var product_price = parseInt(document.getElementById(choice.id.concat(suffix)).innerHTML);
			cost += product_price;
			break;
		case "p3":
		var product_price = parseInt(document.getElementById(choice.id.concat(suffix)).innerHTML);
	...
	document.getElementById("total_price").innerHTML = cost;

}

function delete_from_cart(link){
	var id = link.id;
	var no_purchases = parseInt(document.getElementById("num_of_purchases").innerHTML,10);
	console.log(no_purchases);
	var product_price = parseInt(document.getElementById(id).getAttribute("data-value"),10);
	var total = parseInt(document.getElementById("total_cart").innerHTML,10);
	var td_id = document.getElementById(id.concat("td"));
	total -= product_price;
	switch( id ){
		case "d1":
	...
	document.getElementById("num_of_purchases").innerHTML = no_purchases;
